            ...
            <div style="display:flex; flex-direction:column; gap:10px;">
              ${activeLesson.presentation.examples.map(ex => `
                <div style="background:rgba(56,189,248,0.08); border-left:4px solid #38bdf8; padding:12px 16px; border-radius:0 6px 6px 0; display:flex; align-items:center; justify-content:space-between; gap:10px;">
                  ...
                  <button type="button" class="fearn-speak-btn" onclick="FEARN.audio && FEARN.audio.speak('${escapeHtml(ex.target).replace(/'/g, "\\'")}', 'english')" title="Listen to biological term" style="background:rgba(255,255,255,0.08); border:1px solid rgba(255,255,255,0.18); border-radius:6px; padding:3px 8px; cursor:pointer; font-size:0.95rem; color:#fff;">🔊</button>
                </div>
              `).join('')}
            </div>
          </div>

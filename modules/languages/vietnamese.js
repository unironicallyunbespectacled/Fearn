// FEARN language module: Vietnamese
...
(function (global) {
  ...
  var SUBJECT = 'vietnamese';
  var MODULE_ID = 'lang-vietnamese';
  var LEVEL_LABELS = {
    "A1": "A1 — Beginner",
    "A2": "A2 — Elementary",
    "B1": "B1 — Intermediate",
      ...
      if (Array.isArray(pres.examples) && pres.examples.length) {
        ...
        pres.examples.forEach(function (ex) {
          ...
          if (targetStr && window.FEARN && window.FEARN.audio && window.FEARN.audio.createSpeakButton) {
            var speakBtn = window.FEARN.audio.createSpeakButton(targetStr, 'vietnamese');

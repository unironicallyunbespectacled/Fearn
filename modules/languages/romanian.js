// FEARN language module: Romanian
...
(function (global) {
  ...
  var SUBJECT = 'romanian';
  var MODULE_ID = 'lang-romanian';
  var LEVEL_LABELS = {
    "A1": "A1 — Beginner",
    "A2": "A2 — Elementary",
    "B1": "B1 — Intermediate",
      ...
      if (Array.isArray(pres.examples) && pres.examples.length) {
        ...
        pres.examples.forEach(function (ex) {
          ...
          if (targetStr && window.FEARN && window.FEARN.audio && window.FEARN.audio.createSpeakButton) {
            var speakBtn = window.FEARN.audio.createSpeakButton(targetStr, 'romanian');

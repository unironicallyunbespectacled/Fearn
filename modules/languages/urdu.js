...
(function (global) {
  ...
  var LEVEL_LABELS = {
    ...
    "C1": "C1 — Advanced",
    "C2": "C2 — ACTFL Distinguished / NUML C2"
  };
      ...
      if (Array.isArray(pres.examples) && pres.examples.length) {
        ...
        pres.examples.forEach(function (ex) {
          ...
          if (targetStr && window.FEARN && window.FEARN.audio && window.FEARN.audio.createSpeakButton) {
            var speakBtn = window.FEARN.audio.createSpeakButton(targetStr, 'urdu');
  ...
  FEARN.registerModule({
    ...
    render: function (container) {
      ...
      if (container.classList && typeof container.classList.add === 'function') {
        ...
        container.className = (container.className ? container.className + ' ' : '') + 'fearn-urdu-module';
      }
      var curriculum = getCurriculum();

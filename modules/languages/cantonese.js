...
(function (global) {
  ...
  var SUBJECT = 'cantonese';
  var MODULE_ID = 'lang-cantonese';
  var LEVEL_LABELS = {
    "A1": "A1 — Beginner",
    "A2": "A2 — Elementary",
    "B1": "B1 — Intermediate",
    ...
    "C1": "C1 — Advanced",
    "C2": "C2 — ACTFL Distinguished / CUHK C2"
  };
      ...
      if (Array.isArray(pres.examples) && pres.examples.length) {
        ...
        pres.examples.forEach(function (ex) {
          ...
          if (targetStr && window.FEARN && window.FEARN.audio && window.FEARN.audio.createSpeakButton) {
            var speakBtn = window.FEARN.audio.createSpeakButton(targetStr, 'cantonese');

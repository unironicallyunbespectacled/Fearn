...
- **Instance 1 (This Window)**:
  ...
  - **Korean (`data/curricula/korean.js`, `data/curricula/korean.ledger.js`)**: **WIP REBUILD** (Units 1–24 COMPLETE: 120/170 lessons authored by hand, 100% unique, audited, committed, and pushed in `b22b392`; now authoring Unit 25 `ko-u25-l1` to `ko-u25-l5`).

...
- **Instance 1 (This Window)**:
  ...
  - **Korean (`data/curricula/korean.js`, `data/curricula/korean.ledger.js`)**: **WIP REBUILD** (Units 1–16 COMPLETE: 80/170 lessons authored by hand, 100% unique, audited, committed, and pushed in `0d225d9`; now authoring Unit 17 `ko-u17-l1` to `ko-u17-l5`).

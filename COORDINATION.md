...
- **Instance 1 (This Window)**:
  ...
  - **Korean (`data/curricula/korean.js`, `data/curricula/korean.ledger.js`)**: **WIP REBUILD** (Units 1–6 COMPLETE: 30/170 lessons authored by hand, 100% unique, audited, committed, and pushed in `02fb1dd`; now authoring Unit 7 `ko-u7-l1` to `ko-u7-l5`).

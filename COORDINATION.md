...
- **Instance 1 (This Window)**:
  ...
  - **Korean (`data/curricula/korean.js`, `data/curricula/korean.ledger.js`)**: **WIP REBUILD** (Units 1–5 COMPLETE: 25/170 lessons authored by hand, 100% unique, audited, committed, and pushed in `9bca28e`; now authoring Unit 6 `ko-u6-l1` to `ko-u6-l5`).

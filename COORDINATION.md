...
- **Instance 1 (This Window)**:
  ...
  - **Korean (`data/curricula/korean.js`, `data/curricula/korean.ledger.js`)**: **WIP REBUILD** (Units 1–9 COMPLETE: 45/170 lessons authored by hand, 100% unique, audited, committed, and pushed in `7a8f1a1`; now authoring Unit 10 `ko-u10-l1` to `ko-u10-l5`).

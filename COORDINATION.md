...
- **Instance 1 (This Window)**:
  ...
  - **Korean (`data/curricula/korean.js`, `data/curricula/korean.ledger.js`)**: **WIP REBUILD** (Units 1–26 COMPLETE: 130/170 lessons authored by hand, 100% unique, audited, committed, and pushed in `b0e3495`; now authoring Unit 27 `ko-u27-l1` to `ko-u27-l5`).

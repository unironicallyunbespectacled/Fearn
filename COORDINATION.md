...
- **Instance 1 (Swahili & Amharic Specialist - This Window)**:
  ...
  - **Amharic (`data/curricula/amharic.js`, `data/curricula/amharic.ledger.js`)**: **ACTIVE FOCUS** (Authoring Unit 1 `am-u1-l1` to `am-u1-l5` through Unit 34).

- **Instance 2 (Arabic Specialist - Parallel Window)**:
  - **Active Focus**: Arabic curriculum (`data/curricula/arabic.js`, `data/curricula/arabic.ledger.js`).
  - **Status**: Progressing through Arabic Units 24–34.

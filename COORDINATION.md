...
- **Instance 1 (This Window)**:
  ...
  - **Korean (`data/curricula/korean.js`, `data/curricula/korean.ledger.js`)**: **WIP REBUILD** (Units 1–19 COMPLETE: 95/170 lessons authored by hand, 100% unique, audited, committed, and pushed in `cb9fc4c`; now authoring Unit 20 `ko-u20-l1` to `ko-u20-l5`).

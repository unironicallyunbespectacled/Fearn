...
- **Instance 1 (This Window)**:
  ...
  - **Korean (`data/curricula/korean.js`, `data/curricula/korean.ledger.js`)**: **WIP REBUILD** (Units 1–13 COMPLETE: 65/170 lessons authored by hand, 100% unique, audited, committed, and pushed in `982f946`; now authoring Unit 14 `ko-u14-l1` to `ko-u14-l5`).

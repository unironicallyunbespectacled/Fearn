...
- **Instance 1 (This Window)**:
  ...
  - **Korean (`data/curricula/korean.js`, `data/curricula/korean.ledger.js`)**: **WIP REBUILD** (Units 1–25 COMPLETE: 125/170 lessons authored by hand, 100% unique, audited, committed, and pushed in `8f4a1a7`; now authoring Unit 26 `ko-u26-l1` to `ko-u26-l5`).

...
- **Instance 1 (This Window)**:
  ...
  - **Korean (`data/curricula/korean.js`, `data/curricula/korean.ledger.js`)**: **WIP REBUILD** (Units 1–22 COMPLETE: 110/170 lessons authored by hand, 100% unique, audited, committed, and pushed in `753c5fc`; now authoring Unit 23 `ko-u23-l1` to `ko-u23-l5`).

...
- **Instance 1 (This Window)**:
  ...
  - **Korean (`data/curricula/korean.js`, `data/curricula/korean.ledger.js`)**: **WIP REBUILD** (Units 1–32 COMPLETE: 160/170 lessons authored by hand, 100% unique, audited, committed, and pushed in `3c35651`; now authoring Unit 33 `ko-u33-l1` to `ko-u33-l5`).

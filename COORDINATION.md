...
- **Instance 1 (This Window)**:
  ...
  - **Korean (`data/curricula/korean.js`, `data/curricula/korean.ledger.js`)**: **WIP REBUILD** (Units 1–23 COMPLETE: 115/170 lessons authored by hand, 100% unique, audited, committed, and pushed in `80792be`; now authoring Unit 24 `ko-u24-l1` to `ko-u24-l5`).

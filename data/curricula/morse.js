  ...
  var LESSONS = {
    ...
    "morse-u7-l1": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "Hear the music, not the dots: 20 WPM characters + 9 WPM spacing!",
                "Do not count dits: hear 'di-dah' as a single musical chord (A)!",
                "If you hesitate, let the missed character go and catch the next one immediately!"
            ],
            "culturalNotes": [
                "The standard international unit of Morse speed measurement is the word 'PARIS', which contains exactly 50 dit-duration units (including standard inter-character and inter-word spacing)."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u7-l2": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "10 WPM Milestone: The threshold of operational automaticity!",
                "Copy 1 character behind: let your hand write while your ear catches the next sound!",
                "Numbers have 5 elements (e.g. 5 = .....; 9 = ----.) — hear the smooth count!"
            ],
            "culturalNotes": [
                "In amateur radio contests (like the CQ World Wide DX Contest), thousands of operators exchange millions of 5-character alphanumeric reports at speeds from 10 to 35+ WPM over a single weekend."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u7-l3": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "Hear THE (- .... .) as one single galloping beat!",
                "AND (.- -. -..) flows like water!",
                "Whole-word sound images eliminate letter-by-letter bottleneck!"
            ],
            "culturalNotes": [
                "High-speed Morse operators (20-40+ WPM) hear entire sentences as a musical language, holding extended conversations 'in their head' without ever touching pencil or paper."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u7-l4": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "12 WPM = Pure standard timing: 3 dits between letters, 7 dits between words!",
                "DE = 'From / This is' (-.. .); K = 'Over / Go ahead' (-.-)!",
                "HPE CUAGN = Hope to see you again (standard CW telegrapher shorthand)!"
            ],
            "culturalNotes": [
                "Historically, passing a 12 or 13 WPM Morse code examination was the mandatory requirement for the prestigious FCC General Class Amateur Radio License in the United States."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u7-l5": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "12 WPM MASTERED: You can now communicate across oceans on shortwave radio!",
                "OM = 'Old Man' (affectionate telegrapher term for fellow radio operator)!",
                "FB = 'Fine Business' (excellent / great job in telegrapher slang)!"
            ],
            "culturalNotes": [
                "Reaching 12 WPM effective speed represents the great psychological breakthrough in Morse code—you have crossed the threshold from 'sounding out letters' to 'speaking fluent CW'."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u8-l1": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "HEAR THE WHOLE WORD: Stop spelling T-H-E; hear the rhythm of THE!",
                "PUT DOWN THE PENCIL: Head-copying begins when the hand stops writing!",
                "RHYTHMIC GESTALT: Every 3-letter word has its own unique musical fingerprint!"
            ],
            "culturalNotes": [
                "Maritime and military CW operators in WWII could converse in Morse code while drinking coffee and looking out the window, processing incoming telegraphy as naturally as a spoken podcast."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u8-l2": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "CALLSIGN STRUCTURE: Prefix (Country) + Number (Region) + Suffix (Station)!",
                "W / K / N = USA!",
                "VE = CANADA, G = GREAT BRITAIN, DL = GERMANY, JA = JAPAN!"
            ],
            "culturalNotes": [
                "In international CW DX contests, elite operators decode callsigns sent at 35 to 40 WPM in less than 500 milliseconds, logging over 3,000 international contacts in a single 48-hour weekend."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u8-l3": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "ALL Q-CODES START WITH Q (--.-): Universal 3-letter shorthand!",
                "QTH = 'H' for Home/Location; QSL = 'L' for Log/Receipt!",
                "QRM = 'M' for Man-made noise; QRN = 'N' for Natural static noise!"
            ],
            "culturalNotes": [
                "The Q-Code was created by the British government in 1909 and standardized internationally in 1912 to enable British, French, German, Russian, and Japanese telegraphers to communicate without speaking a single common word."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u8-l4": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "CQ = CALLING ANY STATION; DE = FROM; K = OVER!",
                "RST 599 = 5NN: Perfect readability, loudest strength, purest tone!",
                "73 = BEST REGARDS (--... ...--)!"
            ],
            "culturalNotes": [
                "The traditional 'dit-dit' (EE) at the end of a Morse QSO is the telegraphic equivalent of a warm smile and handshake between two human beings thousands of miles apart across the globe."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u8-l5": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "14 WPM ACHIEVED: Head-copying words and operational exchanges effortlessly!",
                "CALLSIGN -> RST -> OP -> QTH -> 73: The rhythm of global communication!",
                "ADVANCED MORSE MASTERED: Ready for full speed 20+ WPM in Unit 9!"
            ],
            "culturalNotes": [
                "Passing a 14 WPM CW QSO simulation places your decoding skills above the historic FCC commercial telegrapher licensing benchmarks, connecting you to a global lineage of telegraphers spanning nearly two centuries."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u9-l1": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "NEVER LOOK BACK: Miss a letter? Drop it instantly; the sentence will save you!",
                "18 WPM SPEED STREAM: Trust your subconscious acoustic buffer!",
                "HEAR WORD ENDINGS: -ING, -TION, -MENT as unified melodic chords!"
            ],
            "culturalNotes": [
                "Professional telegraphers at press wire agencies (like Reuters and the Associated Press) regularly took down 5,000-word international news stories at 18 to 22 WPM without missing a single punctuation mark."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u9-l2": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "FUSED CHARACTERS: Prosigns have ZERO gap between the two letters!",
                "[AS] = .-.. (Di-dah-di-di-dit: Stand by!)",
                "[KN] = -.--. (Dah-di-dah-dah-dit: ONLY you transmit!)",
                "[SK] = ...-.- (Di-di-di-dah-di-dah: Final sign-off!)"
            ],
            "culturalNotes": [
                "The fraction slash `[DN]` (`-..-.`) is used thousands of times daily by portable amateur radio operators operating from national parks ('Parks on the Air' - POTA) sending callsigns like `K2VX/P`."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u9-l3": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "20 WPM IS NATURAL SPEECH: Listen with your mind, not your pencil!",
                "VISUALIZE THE SCENE: When you hear SUNNY, see the sun in your mind!",
                "THE 20 WPM BADGE OF HONOR: Professional commercial telegrapher speed achieved!"
            ],
            "culturalNotes": [
                "Before modern satellite communications, 20 WPM CW head copy was the mandatory qualification for all shipboard radio officers (Sparks) navigating the high seas under international SOLAS conventions."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u9-l4": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "QSK = FULL BREAK-IN; QSB = FADING SIGNALS!",
                "WX = WEATHER; ES = AND; PSE = PLEASE!",
                "73 = BEST REGARDS; 88 = LOVE AND KISSES!"
            ],
            "culturalNotes": [
                "The abbreviation 'ES' (. ...) for 'AND' comes directly from 19th-century American Morse code and has survived over 175 years of continuous telegraphic usage."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u9-l5": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "20 WPM MASTERED: Professional maritime broadcast decoded flawlessly!",
                "STREAMING COMPREHENSION: Zero latency, zero transcription friction!",
                "ON TO UNIT 10: The ultimate Net Simulation and QSK Break-in Finale!"
            ],
            "culturalNotes": [
                "W1AW (the flagship station of the American Radio Relay League in Newington, Connecticut) has broadcasted daily Morse code bulletins on scheduled frequencies continuously since 1914."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u10-l1": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "QN-CODES ARE NET-SPECIFIC: QNI (Check In), QNX (Excuse/Leave), QNA (Answer in order)!",
                "NCS RULES THE FREQUENCY: Never transmit without NCS calling your callsign!",
                "ZERO BEAT WITH QNZ: Align your audio pitch exactly to the Net Control Station!"
            ],
            "culturalNotes": [
                "During Hurricane Katrina and the 2011 Fukushima earthquake, when power grids, fiber optic backbones, and cellular towers failed, National Traffic System CW nets routed thousands of critical medical and evacuation messages."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u10-l2": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "QSK IS DUPLEX: You can hear the band in the micro-silence between your own dits!",
                "LEFT = DIT; RIGHT = DAH; SQUEEZE BOTH = ALTERNATING DI-DAH-DI-DAH!",
                "MINIMAL FINGER TRAVEL: Let the electronic keyer generate the timing!"
            ],
            "culturalNotes": [
                "Iambic dual-paddle keyers (like Begali and Bencher paddles) are precision mechanical instruments machined to tolerances of less than 0.001 inches, allowing operators to send 40+ WPM with effortless micro-wrist movements."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u10-l3": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "LOCK ONTO THE PITCH: Focus only on the 500 Hz tone; ignore the rest!",
                "THE COCKTAIL PARTY EFFECT: Your brain is the ultimate digital filter!",
                "TRUST THE RHYTHM IN THE MUD: Even if dits are fragmented, your mind connects the pulses!"
            ],
            "culturalNotes": [
                "During Arctic and Antarctic scientific expeditions, radio operators routinely pulled Morse code signals out of polar magnetic storm auroral flutter when satellite and voice communication were completely wiped out."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u10-l4": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "8 DITS = ERROR: Send 8 dits, repeat last good word, keep flying!",
                "SURGICAL FILLS: ? WA (Word After), ? WB (Word Before), ? AA (All After)!",
                "NEVER PANIC: An error is just a speedbump; recover in 1 second!"
            ],
            "culturalNotes": [
                "Military and commercial telegraph traffic handlers were penalized for re-transmitting full messages; mastering surgical ? WA and ? WB fill requests was mandatory to maintain high-volume network efficiency."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u10-l5": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "GRAND OPERATOR ACHIEVED: 50 Lessons of Complete Morse Code Mastery!",
                "THE 5 PILLARS: Koch Characters, Numbers, Farnsworth Spacing, Q-Codes, 20 WPM Head Copy!",
                "THE ETERNAL WIRE: You are now a certified master of the original digital language of humanity!"
            ],
            "culturalNotes": [
                "With the completion of Unit 10, you join the historic lineage of Marconi telegraphers, maritime radio officers, and emergency communications specialists who have preserved this indestructible, life-saving art across three centuries."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u6-l1": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "Period: 3 pairs of dit-dah (.- .- .-).",
                "Question Mark: Sandwich (2 dits, 2 dahs, 2 dits: .. -- ..).",
                "Comma: Bookend (2 dahs, 2 dits, 2 dahs: -- .. --)."
            ],
            "culturalNotes": [
                "In amateur radio CW, the question mark (`..--..`) is also used as a shorthand for 'please repeat / say again?' when missing a piece of incoming data."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u6-l2": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "BT = B (-...) + T (-) merged into one: -...- (Dah-dit-dit-dit-dah).",
                "BT is the comma and full stop of everyday radio chat."
            ],
            "culturalNotes": [
                "Experienced CW operators almost never send formal periods (`.-.-.-`); they use $\\overline{BT}$ (`-...-`) between every sentence to maintain smooth conversational flow."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u6-l3": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "K = 'Kome on in, anyone!' (-.-).",
                "KN = 'Kome on in, Named station only!' (-.--.).",
                "AR = 'All Received / Message Over' (.-.-.)."
            ],
            "culturalNotes": [
                "Sending 'KN' instead of 'K' during a crowded contest or DX pileup is critical radio discipline to prevent 50 other operators from shouting over your conversation partner."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u6-l4": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "SK = 'Signing off, Key is Silent' (...-.-).",
                "AS = 'A Second, please!' (.-...).",
                "8 Dits = 'Oops, erase that word!' (........)."
            ],
            "culturalNotes": [
                "In amateur radio tradition, when a revered telegrapher passes away, their obituary is published in QST magazine under the honorable title 'Silent Key' ($overline{SK}$)."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "morse-u6-l5": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "QSO Flow: CQ -> Answer -> Signal Report (RST 599) -> Name & QTH -> 73 & SK!",
                "BT separates lines; KN directs the reply; SK turns off the key."
            ],
            "culturalNotes": [
                "Standardized CW abbreviations (QTH = location, GM = good morning, OM = operator, FB = fine business, 73 = best regards) allow operators speaking completely different native languages (Japanese, Russian, Spanish, English) to conduct flawless contacts."
            ]
        },
        "guidedPractice": {
            "items": [

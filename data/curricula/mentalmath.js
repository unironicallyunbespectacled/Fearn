  ...
  var LESSONS = {
    ...
    "mentalmath-u4-l1": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "Multiply the front by 'one higher', then tack on 25.",
                "35 -> 3x4=12 -> 1225. 75 -> 7x8=56 -> 5625."
            ],
            "culturalNotes": [
                "This algorithm is known in Vedic mathematics as 'Ekadhikena Purvena' (By one more than the previous one) and has been used by rapid human calculators for centuries."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u4-l2": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "Go up by 'd', go down by 'd', multiply the two, then add d².",
                "One number always ends in 0, making the multiplication instantaneous."
            ],
            "culturalNotes": [
                "Arthur Benjamin (author of 'Secrets of Mental Math' and legendary 'Mathemagician') uses this exact difference-of-squares algorithm for all 2-digit and 3-digit mental squaring performances."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u4-l3": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "10% is just moving the dot. 5% is cutting 10% in half.",
                "If the percentage is ugly but the number is friendly (25, 50, 75), FLIP THEM!"
            ],
            "culturalNotes": [
                "The Percentage Reversibility Law went viral on social media in 2019 when British mathematician Ben Stephens tweeted 'x% of y = y% of x', astonishing millions who were never taught this elementary algebraic symmetry in grade school."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u4-l4": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "Elevenths multiply by 9: 4/11 -> 4x9=36 -> 0.3636...",
                "Ninths repeat their numerator: 7/9 -> 0.7777...",
                "Sevenths loop the magic 142857 wheel."
            ],
            "culturalNotes": [
                "The number 142,857 is the best-known cyclic number in base-10 mathematics: $142857 \\times 2 = 285714, \\times 3 = 428571, \\times 4 = 571428, \\times 5 = 714285, \\times 6 = 857142$, and $\\times 7 = 999999$!"
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u4-l5": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "See the pattern first, then execute the formula.",
                "Pattern match -> Sub-assembly -> Instant answer."
            ],
            "culturalNotes": [
                "World Mental Calculation Cup competitors solve 50+ mixed problems of this exact type per minute by chaining these specialized mental pathways."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u6-l1": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "Unwind outside-in: subtract the constant first, then divide by coefficient!",
                "For factored forms: divide first, then shift the inside offset!",
                "Subtract smaller x from larger x to keep coefficients positive!"
            ],
            "culturalNotes": [
                "Mental algebra is the fundamental skill required for real-time quantitative trading interviews and elite physics Olympiad problem solving."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u6-l2": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "(Midpoint)² - (Distance)² = Answer!",
                "Midpoint 50 -> 2500 - d²!",
                "Midpoint 100 -> 10000 - d²!"
            ],
            "culturalNotes": [
                "In Vedic mathematics, this shortcut is known as 'Varganaam Antaram' (Square Differences) and is prized by mental math champions for its lightning speed."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u6-l3": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "15% = 10% + (Half of 10%)!",
                "18% = 20% - (2 x 1%)!",
                "Rule of 72: Divide 72 by the rate to find doubling years!"
            ],
            "culturalNotes": [
                "The Rule of 72 was first documented by Renaissance mathematician Luca Pacioli in 1494 in his 'Summa de arithmetica' and remains Wall Street's favorite quick mental heuristic."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u6-l4": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "1 Significant Figure for speed, track exponents in your head!",
                "Seconds in a year ≈ π x 10⁷ (31.5 million)!",
                "Powers of 10 add in multiplication, subtract in division!"
            ],
            "culturalNotes": [
                "Enrico Fermi famously estimated the explosive yield of the first nuclear test at Trinity in 1945 by dropping scraps of paper as the blast wave arrived and calculating the displacement distance in his head."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u6-l5": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "TRUST THE PATTERNS: Linear reverse, (Midpoint)² - d², 10% + 5%, Rule of 72!",
                "Mental speed is the elimination of hesitation through pattern recognition (#ScienceOfLearning)."
            ],
            "culturalNotes": [
                "Mental math speed competitions (such as the Mental Calculation World Cup) require participants to compute 8-digit square roots and complex mental algebra with zero scratch paper in fractions of a minute."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u7-l1": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "RUNNING ACCUMULATOR: Keep only ONE number active in working memory!",
                "SUBTRACT WITH COMPLEMENT: -198 = -200 + 2!",
                "LEFT-TO-RIGHT: Hundreds first, then tens, then units!"
            ],
            "culturalNotes": [
                "Competitive mental math champions (like Shakuntala Devi and Arthur Benjamin) rely on continuous auditory running registers, converting intermediate numbers into rhythmic spoken phrases in their inner voice."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u7-l2": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "FUSE PRODUCT TO SUM: Compute product and immediately bridge into addition!",
                "USE COMPATIBLE FACTORING: 75 × 12 = 75 × 4 × 3 = 300 × 3 = 900!",
                "CANCEL COMMON SUFFIXES: 456 - 156 = 300!"
            ],
            "culturalNotes": [
                "In algorithmic trading and options trading pits, quants compute synthetic option delta payoffs by multiplying contract sizes and adding basis points in real time using these exact fused shortcuts."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u7-l3": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "X% OF Y = Y% OF X: Reverse the percentage when the base is easier!",
                "12.5% IS 1/8: Divide by 8!",
                "35% = 3 × 10% + Half of 10%!"
            ],
            "culturalNotes": [
                "Venture capitalists, business angels, and CFOs calculate cap table equity dilution and margin hurdles during live pitch meetings using these exact fractional conversion shortcuts."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u7-l4": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "CAST OUT NINES: Eliminate pairs adding to 9 (8+1, 7+2, 6+3, 5+4)!",
                "MODULO 11: Alternating right-to-left (+ - + -)!",
                "DIVISIBLE BY 7: Rest minus (2 × last digit)!"
            ],
            "culturalNotes": [
                "Casting out nines has been used by Persian mathematicians (like Al-Khwarizmi) since the 9th century to audit arithmetic ledgers across Silk Road trade routes before the invention of double-entry bookkeeping."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u7-l5": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "60-SECOND FOCUS: One running accumulator at a time!",
                "LEVERAGE SHORTCUTS: Spot difference of squares, percentage reversals, and 11-tricks instantly!",
                "MODULO CHECK: Automatic background verification!"
            ],
            "culturalNotes": [
                "In the Mental Calculation World Cup, grandmasters solve 10 multi-operation problems in under 45 seconds with 100% accuracy using these exact fused mental pathways."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u8-l1": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "URDHVA TIRYAGBHYAM: 1. Vertically right -> 2. Criss-cross sum -> 3. Vertically left!",
                "HOLD THE CARRY: Only hold ONE carry digit at each crosswise step!",
                "UNIVERSAL ENGINE: Works on ANY two numbers without special properties!"
            ],
            "culturalNotes": [
                "The Urdhva Tiryagbhyam sutra from ancient Vedic mathematics is now widely implemented in high-performance digital DSP chips and FPGA multiplier pipelines due to its parallelizable crosswise architecture."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u8-l2": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "CUBE ENDINGS: 1, 4, 5, 6, 9 keep their digit! 2 <-> 8 and 3 <-> 7 swap (10-complements)!",
                "THOUSANDS PART FOR TENS: Find the bracket between 1³ and 9³!",
                "UNDER 1 SECOND: Tens from left chunk, units from last digit!"
            ],
            "culturalNotes": [
                "In the 1970s, mental prodigy Shakuntala Devi famously extracted the 23rd root of a 201-digit number in 50 seconds, beating a UNIVAC 1101 mainframe computer by 10 seconds using these generalized modular root principles."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u8-l3": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                ...
                "ODD MONTHS: 9-to-5 at the 7-11 (5/9, 9/5, 7/11, 11/7)!",
                "CENTURIES: 1800=Fri(5), 1900=Wed(3), 2000=Tue(2), 2100=Sun(0)!"
            ],
            "culturalNotes": [
                "John Conway programmed his computer terminal at Princeton to quiz him on 10 random calendar dates every morning; he achieved an average calculation speed of under 2.5 seconds per date."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u8-l4": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "DECOMPOSE INTO 4 FACTORS: Population -> Fraction -> Frequency -> Capacity!",
                "ERRORS CANCEL OUT: Geometric mean balances high and low guesses!",
                "PI * 10^7: There are approximately pi * 10^7 (31.5 million) seconds in a year!"
            ],
            "culturalNotes": [
                "Nobel laureate Enrico Fermi famously calculated the explosive yield of the first atomic bomb test (Trinity) by dropping small pieces of paper from his hand and measuring how far the shockwave blew them."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u8-l5": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "SAVANT FLUENCY ACHIEVED: 40 Lessons of Pure Mental Arithmetic Mastery!",
                "STREAMING ARITHMETIC: No scratch paper, no carrying fatigue, 100% memory efficiency!",
                "THE HUMAN CALCULATOR: You now calculate faster than a human typing into an iPhone!"
            ],
            "culturalNotes": [
                "With the completion of Unit 8, you have mastered every core technique taught in elite mental calculation academies, from the Vedic sutras of ancient India to John Conway's modern combinatorial algorithms."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u5-l1": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "Right straight down -> Criss-cross and add -> Left straight down!",
                "Vedic formula: Urdhva Tiryagbhyam (Vertically and Crosswise)."
            ],
            "culturalNotes": [
                "The Vedic mathematical sutra 'Vertically and Crosswise' has been used by human computers and lightning mental calculators for centuries to bypass written column scratchpads."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u5-l2": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "Cross-add the surpluses -> Multiply the ends!",
                "Deficiencies from 100: subtract across, multiply the gap!"
            ],
            "culturalNotes": [
                "Known as 'Nikhilam Navatashcaramam Dashatah' in Vedic math ('All from 9 and the last from 10'), this method is considered one of the fastest mental arithmetic shortcuts ever discovered."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u5-l3": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "Ending in 5: Number times Next Number, attach 25!",
                "Equidistant pair: Square the middle, subtract the gap squared!"
            ],
            "culturalNotes": [
                "In physics and quantitative trading interviews, mental difference-of-squares is one of the most frequently tested mental arithmetic shortcuts."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u5-l4": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "Multiplying by 11: Open the bread (a and b), put the sum in the middle!",
                "If the sum overflows 10, add 1 to the left bread slice!"
            ],
            "culturalNotes": [
                "The 11-trick extends to numbers of any length (e.g. $1234 \\times 11 = 13574$ by adding adjacent neighbor digits from right to left)."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "mentalmath-u5-l5": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "Scan the shape before calculating: 5s, 11s, Symmetries, Base 100, or Criss-Cross!",
                "Work left to right or stream units to tens with zero paper!"
            ],
            "culturalNotes": [
                "Championship mental athletes (like Shakuntala Devi and Scott Flansburg) do not use a single brute-force algorithm; they intuitively route each calculation through its most symmetric algebraic shortcut."
            ]
        },
        "guidedPractice": {
            "items": [

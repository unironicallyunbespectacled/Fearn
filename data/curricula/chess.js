  ...
  var LESSONS = {
    ...
    "chess-u8-l1": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "A HOLE is a square that pawns can NEVER defend again!",
                "KNIGHT ON THE 6TH RANK = Monster Octopus piece!",
                "Fix the backward pawn -> Trade the defender -> Occupy the outpost!"
            ],
            "culturalNotes": [
                "Aron Nimzowitsch formulated the foundational theory of outposts and blockades in his 1925 masterpiece 'Mein System' (My System), transforming modern chess strategy forever."
            ]
        },
        "guidedPractice": {
            "items": [
                ...
                },
                {
                    ...
                    "options": [
                        "The Pawn",
                        "The Rook",
                        "The Knight (because its short-range reach is maximized when planted deep in the opponent's territory)",
                        "The King"
                    ],
                    "answerIndex": 2,
    ...
    "chess-u8-l2": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "ONE WEAKNESS = Draw; TWO WEAKNESSES = Win!",
                "Tie them down on the Queenside -> Strike on the Kingside!",
                "Stretched defenders snap under bilateral pressure!"
            ],
            "culturalNotes": [
                "Grandmaster Mark Dvoretsky in his legendary 'Endgame Manual' identified the Principle of Two Weaknesses as the single most critical strategic tool for converting technical advantages into tournament victories."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "chess-u8-l3": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "BAD BISHOP = Biting on own pawns on same color squares!",
                "GOOD BISHOP = Free diagonals, attacks enemy pawns!",
                "TRADE YOUR BAD BISHOP for their good piece immediately!"
            ],
            "culturalNotes": [
                "In the 1972 World Championship Match, Bobby Fischer demonstrated the ultimate 'Good Knight vs. Bad Bishop' conversion in Game 6 against Boris Spassky, creating one of the most celebrated positional games in chess history."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "chess-u8-l4": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "ROOKS ON OPEN FILES: Find the highway and double up!",
                "ALEKHINE'S GUN: Rook + Rook + Queen on a single file!",
                "PIGS ON THE 7TH RANK: Doubled rooks devour pawns and checkmate kings!"
            ],
            "culturalNotes": [
                "The colorful phrase 'Pigs on the 7th' was popularized by American Grandmaster Reuben Fine, describing how doubled rooks on the 7th rank root around and gobble up enemy pawns like hungry swine."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "chess-u8-l5": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "PROPHYLAXIS: Stop their plan before you launch yours!",
                "THE BOA CONSTRICTOR: Outpost + Open File + 7th Rank + Zugzwang!",
                "Karpov's law: Restrict, Dominate, Infiltrate, Win!"
            ],
            "culturalNotes": [
                "Anatoly Karpov held the World Championship title from 1975 to 1985, winning over 160 international grandmaster tournaments through his peerless python-like positional squeeze technique."
            ]
        },
        "guidedPractice": {
            "items": [
        ...
        "checkpointTest": {
            "items": [
                ...
                },
                {
                    ...
                    "options": [
                        "Anatoly Karpov (alongside Tigran Petrosian and José Raúl Capablanca)",
                        "Mikhail Tal (celebrated for wild sacrificial attacks)",
                        "Paul Morphy",
                        "Garry Kasparov only"
                    ],
                    "answerIndex": 0,
    ...
    "chess-u9-l1": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "RUY LOPEZ (1.e4 e5 2.Nf3 Nc6 3.Bb5): Pressure c6, preserve bishop on c2, swing knight d2-f1-g3!",
                "PAWN STRUCTURE DICTATES PLAN: Opening moves are merely the gateway to the middlegame pawn skeleton!",
                "PRESERVE THE SPANISH BISHOP: Keep the Bb3/c2 bishop pointing at Black's king!"
            ],
            "culturalNotes": [
                "The Ruy Lopez is named after the 16th-century Spanish bishop Ruy López de Segura, and has been the cornerstone opening of almost every Classical World Champion, from Steinitz, Lasker, and Capablanca to Fischer, Karpov, Kasparov, and Carlsen."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "chess-u9-l2": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "SICILIAN IMBALANCE: White gets development & kingside attack; Black gets central majority & c-file!",
                "THE NAJDORF (5...a6): Controls b5, supreme tactical flexibility!",
                "THE THEMATIC BREAK (...d5): When Black plays ...d5 safely, Black is winning!"
            ],
            "culturalNotes": [
                "Bobby Fischer once famously declared the Sicilian Najdorf to be virtually unassailable, scoring countless historic wins with it throughout his 1970–1972 World Championship campaign."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "chess-u9-l3": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "QUEEN'S GAMBIT (1.d4 d5 2.c4): Not a real gambit—White easily recovers the pawn!",
                "CARLSBAD MINORITY ATTACK: White pushes a3-b4-b5 to create the weak c6 target!",
                "SLAV DEFENSE (2...c6): Solid d5 anchor without locking in the light-squared bishop!"
            ],
            "culturalNotes": [
                "The Queen's Gambit Declined was the centerpiece battlefield of the legendary 1927 World Championship match between Alexander Alekhine and José Raúl Capablanca, played in Buenos Aires over 34 grueling classical games."
            ]
        },
        "guidedPractice": {
            "items": [
            ...
            "items": [
                ...
                },
                {
                    ...
                    "options": [
                        ...
                        "The Carlsbad Pawn Structure (from the QGD Exchange Variation)",
                ...
                },
                {
                    ...
                    "options": [
                        "deep positional preparation and pawn breaks (like e4 or c5)",
                        "random wild moves",
                        "stalemates",
                        "ignoring the center"
                    ],
    ...
    "chess-u9-l4": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "KING'S INDIAN (KID): Lock center with d5, storm kingside with f5-f4 and g5-g4!",
                "NIMZO-INDIAN (3...Bb4): Pin the knight, double White's c-pawns, blockade dark squares!",
                "HYPERMODERN PRINCIPLE: Control the center from afar; strike when the center overextends!"
            ],
            "culturalNotes": [
                "The King's Indian Defense was Garry Kasparov's most terrifying psychological weapon against Anatoly Karpov, while the Nimzo-Indian has been considered the most fundamentally sound defense against 1.d4 for over a century."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "chess-u9-l5": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "TRANSPOSITIONS ARE WEAPONS: Steer games away from opponent prep into your territory!",
                "PAWN SKELETON FIRST: Understand the structure; the moves follow naturally!",
                "HARMONIZED REPERTOIRE: Know your responses to 1.e4, 1.d4, 1.c4, and 1.Nf3!"
            ],
            "culturalNotes": [
                "In modern elite chess preparation, Super-GMs (like Magnus Carlsen, Fabiano Caruana, and Hikaru Nakamura) spend hundreds of hours using neural network engines (Stockfish/Leela) to find subtle move-order nuances on moves 8 to 15 that steer games into favorable middlegame structures."
            ]
        },
        "guidedPractice": {
            "items": [
            ...
            "items": [
                ...
                },
                {
                    ...
                    "options": [
                        ...
                        "Deep Calculation, Candidate Moves & Prophylaxis (Kotov's tree of calculation, prophylactic thinking, Karpov/Petrosian restriction, and blindfold visualization)",
        ...
        "checkpointTest": {
            "items": [
                ...
                },
                {
                    ...
                    "options": [
                        "A Reversed Sicilian (Four Knights Sicilian with White playing Black's Sicilian setup with an extra tempo)",
                        "A French Defense",
                        "A Caro-Kann Defense",
                        "A King's Gambit"
                    ],
    ...
    "chess-u10-l1": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "KOTOV'S LAW: List candidate moves FIRST; calculate each branch strictly ONCE!",
                "NO JUMPING: Finish Branch A before looking at Branch B!",
                "WATCH VACATED SQUARES: When a piece moves, its old square is empty!"
            ],
            "culturalNotes": [
                "Alexander Kotov wrote 'Think Like a Grandmaster' in 1970 after winning the 1952 Saltsjöbaden Interzonal by a staggering 3-point margin, codifying the Soviet chess school's rigorous calculation protocols."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "chess-u10-l2": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "ASK BEFORE EVERY MOVE: 'What does my opponent want to do?'",
                "KILL THE ENEMY PLAN FIRST: Neutralize counterplay before launching attacks!",
                "IMPROVE YOUR WORST PIECE: When opponent is paralyzed, upgrade your worst piece!"
            ],
            "culturalNotes": [
                "9th World Champion Tigran Petrosian earned the nickname 'Iron Tigran' for his uncanny ability to spot opponent tactical threats 5 moves in advance and dismantle them so quietly that grandmaster opponents felt like they were suffocating in quicksand."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "chess-u10-l3": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "MATERIAL IS RELATIVE: A dominant knight on an outpost beats a trapped rook!",
                "THE EXCHANGE SACRIFICE: Give 5 points for 3 points to buy absolute board dominance!",
                "ROOKS NEED OPEN FILES: In locked positions, minor pieces reign supreme!"
            ],
            "culturalNotes": [
                "Tigran Petrosian's exchange sacrifice against Samuel Reshevsky at the 1953 Zurich Candidates Tournament is widely regarded as one of the top 10 most influential strategic moves in the history of chess."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "chess-u10-l4": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "KNIGHT ALWAYS SWITCHES COLOR: Light -> Dark -> Light on every hop!",
                "ODD+ODD = DARK; EVEN+ODD = LIGHT: Instant mental square color math!",
                "UPDATE AND ERASE: Delete the piece from the old square in your mind's eye!"
            ],
            "culturalNotes": [
                "In 1947, Miguel Najdorf played 45 simultaneous blindfold games in São Paulo, winning 39, drawing 4, and losing only 2 across 24 consecutive hours of pure mental calculation, setting a historic world record."
            ]
        },
        "guidedPractice": {
            "items": [
                ...
                },
                {
                    ...
                    "options": [
                        "All 8 destination squares are Dark squares (knights always change square color on every single move)",
    ...
    "chess-u10-l5": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "GRANDMASTER MASTERY ACHIEVED: 50 Lessons of Complete Chess Strategy!",
                "THE GRANDMASTER CYCLE: Prophylaxis -> Structural Pressure -> Candidate Tree -> Endgame Conversion!",
                "THINK LIKE A GRANDMASTER: Precision, patience, and unstoppable dynamic harmony!"
            ],
            "culturalNotes": [
                "With the completion of Unit 10, you have mastered every strategic and tactical pillar taught in the elite Soviet and modern Grandmaster training academies, bridging Wilhelm Steinitz's classical principles with modern neural-network engine evaluation dynamics."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "chess-u7-l1": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "King in front of the pawn, not behind!",
                "Odd number of squares between kings on your move = You HOLD the opposition!"
            ],
            "culturalNotes": [
                "Capablanca famously remarked: 'In order to improve your game, you must at first study the endgame; for while the endings can be studied and mastered by themselves, the middle game and opening must be studied in relation to the end game.'"
            ]
        },
        "guidedPractice": {
            "items": [
            ...
            "items": [
                ...
                },
                {
                    ...
                    "options": [
                        ...
                        "A queen pin",
                        "Kings facing each other on the same file with 3 or 5 squares between them (an odd number of squares)",
                        "A rook lift"
                    ],
                    "answerIndex": 2,
                ...
                },
                {
                    ...
                    "options": [
                        "3 squares directly one rank ahead (d7, e7, f7)",
                        "1 square",
                        "None",
                        "6 squares"
                    ],
    ...
    "chess-u7-l2": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "Inside the square = Caught! Outside the square = Queen!",
                "Triangulation: Spend 3 moves while the enemy only has 2."
            ],
            "culturalNotes": [
                "The Rule of the Square was formalized in early 19th-century European chess manuals and remains the most famous geometric shortcut in chess literature."
            ]
        },
        "guidedPractice": {
            "items": [
    ...
    "chess-u7-l3": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "Rook to the 4th rank -> King steps out -> Rook drops the bridge shield!",
                "Lucena = Lift to the 4th, escort to the queen!"
            ],
            "culturalNotes": [
                "First published in 1497 by Lucena in Salamanca, Spain, this technique is considered the oldest surviving fully analyzed endgame blueprint in modern chess."
            ]
        },
        "guidedPractice": {
            "items": [
            ...
            "items": [
                ...
                },
                {
                    ...
                    "options": [
                        "Garry Kasparov",
                        "Alexander Alekhine",
                        "Luis Ramírez de Lucena (1497 Spanish chess master)",
                        "Emanuel Lasker"
                    ],
                    "answerIndex": 2,
    ...
    "chess-u7-l4": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "Hold the 3rd rank until the pawn moves; the second it moves, drop to the 1st and check from behind!",
                "Philidor = 3rd rank barrier -> 1st rank harassment."
            ],
            "culturalNotes": [
                "François-André Philidor (1726–1795) was both a world-class opera composer and the strongest chess player of the 18th century, famous for coining the immortal maxim 'Pawns are the soul of chess.'"
            ]
        },
        "guidedPractice": {
            "items": [
            ...
            "items": [
                {
                    ...
                    "options": [
                        "Lucena: Attacker WIN (Building the bridge) | Philidor: Defender DRAW (3rd-rank hold & rear checks)",
                ...
                },
                {
                    ...
                    "options": [
                        "Paul Morphy",
                        "François-André Danican Philidor (L'Analyze du jeu des Échecs)",
                        "Wilhelm Steinitz",
                        "Magnus Carlsen"
                    ],
                    "answerIndex": 1,
    ...
    "chess-u7-l5": {
        ...
        "presentation": {
            ...
            "mnemonics": [
                "Opposition opens the path; Lucena builds the bridge; Philidor holds the fort!",
                "Endgame mastery turns half-points into full points."
            ],
            "culturalNotes": [
                "Grandmaster Mark Dvoretsky's training methods emphasize that master-level players must know theoretical endgame positions with absolute, automatic, reflexive precision."
            ]
        },
        "guidedPractice": {
            "items": [
                ...
                },
                {
                    ...
                    "options": [
                        "The Philidor Defense (3rd-rank cut-off and rear checks)",
                        "The Lucena Position",
                        "The Fried Liver",
                        "The Scholar's Mate"
                    ],

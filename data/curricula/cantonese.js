...
(function(global){
  ...
  var LESSONS = {
    "hk-u1-l1": {
        ...
        "presentation": {
            "explanation": "歡迎學習廣東話（粵語，Cantonese）！廣東話語音系統採用香港語言學學會制定之標準粵拼方案（Jyutping）。廣東話塞音無清濁對立，而以送氣與否為核心區別：不送氣清塞音 b [p]（如「爸爸」baa4 baa1）、「打」daa2、「大家」daai6 gaa1，對比強烈送氣清塞音 p [pʰ]（如「害怕」paa3）、「聽日」ting1 jat6、「企立」kei5 laap6。廣東話具備六個基本聲調（6 Tones）：第一聲陰平高平調（如「詩」si1）、第二聲陰上高升調（如「史」si2）、第三聲陰去中平調（如「試」si3）、第四聲陽平低降調（如「時」si4）、第五聲陽上低升調（如「市」si5）、第六聲陽去低平調（如「事」si6）。日常核心見面問候語包括「早晨」（zou2 san4，早上問候好）與「你好」（nei5 hou2，禮貌問候）。廣東話完整保留了入聲韻尾（-p, -t, -k），音韻鏗鏘有力，富有古典漢語韻律美感。 【粵語語言學要點】本課著重訓練粵語標準發音與日常真實交際能力，學習者應反覆聆聽標準粵語語音並掌握地道語法句式。",
            "examples": [
                {
                    "target": "早晨！今日天氣真係好好。",
    ...
    "hk-u2-l5": {
        ...
        "presentation": {
            "explanation": "廣東話之指示詞系統層次分明，以空間距離之遠近為基準，並與量詞及處所名詞緊密結合：\n\n一、近指代詞（靠近說話者空間）：\n１．「呢個」：這個（物件/人）。\n２．「呢度」或「呢便」：這裡、這兒、這邊。\n３．「呢啲」：這些（複數指示）。\n\n二、遠指代詞（遠離說話者空間）：\n１．「嗰個」：那個（物件/人）。\n２．「嗰度」或「嗰便」：那裡、那兒、那邊。\n３．「嗰啲」：那些（複數指示）。\n\n三、疑問處所代詞：\n１．「邊度」或「邊便」：哪裡、哪兒、何處。例如：「地鐵站喺邊度？」（地鐵站在哪裡？）。 【粵語語言學要點】本課著重訓練粵語標準發音與日常真實交際能力，學習者應反覆聆聽標準粵語語音並掌握地道語法句式。",
            "examples": [
                {

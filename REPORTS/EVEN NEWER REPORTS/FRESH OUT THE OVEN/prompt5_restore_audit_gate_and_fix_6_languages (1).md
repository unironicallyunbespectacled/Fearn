...
7. **Do not touch `scripts/audit_curricula_uniqueness.js` again after steps 1 and 5.** No further edits to any quality-gate script for the remainder of this task or any future task, full stop.

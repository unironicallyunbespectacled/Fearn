...
### 5g. Legibility — no wall-of-text lessons, and no raw, unrendered markdown syntax anywhere

Two related, previously-confirmed problems, both in scope across every Frond — languages, fitness, and every non-language skill/course:
